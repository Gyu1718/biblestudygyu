(function () {
  ...
  if (/\/nt\/acts\//i.test(location.pathname) || (document.body && document.body.getAttribute("data-book")==="acts")) {
    if (document.body && document.body.getAttribute("data-kind")==="study") {
      ...
      if (parseInt(document.body.getAttribute("data-chapter")||"0",10)>0) {
    ...
    if (document.body && document.body.classList.contains("book-shelf-page")) addScript("assets/js/acts-topic-shelf.js?v=20260801.7", "data-acts-topic-shelf-js");
  }
