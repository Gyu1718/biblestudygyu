(function () {
  ...
  function addScript(path, marker) { if (document.querySelector('script[' + marker + ']')) return; var node=document.createElement("script");node.src=new URL(path,siteRoot).href;node.setAttribute(marker,"");document.head.appendChild(node); }
  ...
  if (/\/nt\/acts\//i.test(location.pathname) || (document.body && document.body.getAttribute("data-book")==="acts")) {
    addScript("assets/js/acts-chapter-links.js?v=20260801.4", "data-acts-chapter-links-js");
  }
