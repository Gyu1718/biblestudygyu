...
/* 공통 테마·자동 대비 로더: 홈페이지에도 연구 문서와 같은 테마 체계를 적용한다. */
(function () {
  if (typeof document === "undefined") return;
  function css(href, key) {
    if (document.querySelector('link[data-shared-theme="' + key + '"]')) return;
    var link = document.createElement("link");
    link.rel = "stylesheet";
    link.href = href;
    link.dataset.sharedTheme = key;
    document.head.appendChild(link);
  }
  function js(src, key) {
    if (document.querySelector('script[data-shared-theme="' + key + '"]')) return;
    var script = document.createElement("script");
    script.src = src;
    script.defer = true;
    script.dataset.sharedTheme = key;
    document.head.appendChild(script);
  }
  css("assets/theme.css", "theme");
  css("assets/app.css", "app");
  css("assets/css/auto-contrast.css", "contrast-css");
  js("assets/js/auto-contrast.js", "contrast-js");
  js("assets/app.js", "app-js");
})();
