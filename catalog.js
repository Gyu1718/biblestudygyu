  ...
  sections: [
    ...
    },
    {
      ...
      studies: [{
        ...
        meta: "표준형 서가 — 성경읽기 · 종합 개관 1편 · 저장소 기준 장별 심층연구 1–9장 · 원어 연구 미구현",
        desc: "로마서의 역사적 정황과 신학적 구조를 조망하고, 현재 저장소에 실제 존재하는 1–9장 심층연구를 연결한다. 원어 연구와 미배포 장은 준비 중으로 표시한다.", volumes: 10
      }]
    },
    {
