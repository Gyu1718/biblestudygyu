      ...
      studies: [
        {
          ...
          script: "grk",
          meta: "표준형 서가 — 성경읽기 · 종합 개관 1편 · 장별 심층연구 5편 완성(28장 예정) · 원어 연구 준비 중",
          desc: "오순절 성령 강림에서 로마의 셋집까지, 한 증언이 예루살렘에서 땅 끝으로 나아간다. Bruce(NICNT)·Peterson(PNTC)·Schnabel(ZECNT) 세 주석을 절 범위 단위로 종합하고 개역개정 4판과 NA28로 대조한다. 종합 개관과 1–5장 심층연구를 완성했고 6–28장을 같은 규격으로 이어간다.",
          volumes: 6
        },
        {
          id: "romans",
