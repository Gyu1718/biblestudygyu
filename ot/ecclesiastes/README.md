...
사용자의 Google Drive `<도서>` 아래에서 본문을 판독하고 대조한 다섯 자료로 처음 연구를 만들고, 이후 롱맨·바르톨로뮤·프로반 세 주석을 EPUB 판독본으로 대조해 더했습니다. 세 주석의 층은 `added_commentaries.py`에 따로 저장되며 빌드할 때 기존 단락·해석 논쟁·종합 개관에 합쳐집니다.
...
| L | Tremper Longman III, *The Book of Ecclesiastes*, NICOT | 틀 화자와 코헬렛의 구별, 장별 요약 |
| Ba | Craig G. Bartholomew, *Ecclesiastes*, BCOTWP | 인식론 비판, 모순의 병치, 신학적 함의 |
| P | Iain Provan, *Ecclesiastes, Song of Songs*, NIVAC | 헤벨의 덧없음 독법, 본래 의미와 현대적 적용 |
