...
입력: ot/deuteronomy/lexicon_spec.py (사람이 쓴 설명)
      data/interlinear/deuteronomy/NN.json (tools/interlinear 파이프라인 결과)
출력: ot/deuteronomy/lexicon_data.py

히브리어 표기와 음역은 STEPBible TAHOT(CC BY 4.0)에서 그대로 가져오고,
강세 부호만 지운다. 빈도는 Strong 번호 기준 신명기 전체 출현 횟수다.
"""
...
DATA = ROOT / 'data' / 'interlinear' / 'deuteronomy'
